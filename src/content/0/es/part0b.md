...
Cree un diagrama que describa la situación en la que el usuario accede a la versión de [aplicación de una sola página](/es/part0/fundamentos_de_las_aplicaciones_web#formularios-y-http-post) de la aplicación de notas en <https://studies.cs.helsinki.fi/exampleapp/spa>.
